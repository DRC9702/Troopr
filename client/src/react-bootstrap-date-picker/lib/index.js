...
var Calendar = (0, _createReactClass2.default)({
  ...
  propTypes: {
    selectedDate: _propTypes.object,
    displayDate: _propTypes.object.isRequired,
    minDate: _propTypes.string,
    maxDate: _propTypes.string,
    onChange: _propTypes.func.isRequired,
    dayLabels: _propTypes.array.isRequired,
    cellPadding: _propTypes.string.isRequired,
    weekStartsOn: _propTypes.number,
    showTodayButton: _propTypes.bool,
    todayButtonLabel: _propTypes.string,
    roundedCorners: _propTypes.bool,
    showWeeks: _propTypes.bool
  },
